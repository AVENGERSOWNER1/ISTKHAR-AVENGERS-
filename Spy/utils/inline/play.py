...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton("˹ ᴜᴘᴅᴧᴛᴇ ˼", url="https://t.me/ShiriUpdate"),
            InlineKeyboardButton("˹ sᴜᴘᴘᴏꝛᴛ  ˼", url="https://t.me/+ijVUQc7TNEUwNmNl")            
        ],
        [
...
def stream_markup(_, chat_id):
    buttons = [
       ...
       [
            InlineKeyboardButton(
                text="✰ ᴜᴘᴅᴧᴛᴇ ✰", url=f"https://t.me/ShiriUpdate"
            ),
            InlineKeyboardButton(
                text="✰ sᴜᴘᴘᴏꝛᴛ ✰", url=f"https://t.me/+ijVUQc7TNEUwNmNl"
            )
        ],
